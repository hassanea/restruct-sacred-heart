<template>
  <div class="w-full h-auto flex flex-col justify-center items-center">
    ...
    <div
      v-if="show"
      :id="descId"
      class="bg-[#b5d6d6] text-dark text-center font-sans not-italic font-medium text-base md:text-lg leading-relaxed p-8 rounded-2xl mt-3.5 max-w-120 max-h-90 drop-shadow overflow-auto indent-2.5 text-pretty text-clip w-full h-auto flex flex-col justify-center items-center"
    >
      <slot></slot>
    </div>
  </div>
